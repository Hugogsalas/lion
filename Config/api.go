...
func main() {
	...
	router.HandleFunc("/TipoTaller/update", controllers.UpdateTiposTaller).Methods("PUT")
	router.HandleFunc("/TipoExposicion/create", controllers.CreateTipoExposicion).Methods("POST")
	router.HandleFunc("/TipoExposicion/get", controllers.GetTiposExposicion).Methods("POST")
	router.HandleFunc("/TipoExposicion/update", controllers.UpdateTiposExposicion).Methods("PUT")
